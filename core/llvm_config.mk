...
# clang does not support -Wno-psabi, -Wno-unused-but-set-variable,
# -Wno-unused-but-set-parameter, and -fno-toplevel-reorder
...
$(call clang-flags-subst,-fno-toplevel-reorder,)
