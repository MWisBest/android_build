...
def add_to_manifest(repositories, fallback_branch = None):
    ...
    for repository in repositories:
        ...
        if repo_name == "android_device_samsung_toro" or repo_name == "android_device_samsung_tuna" or repo_name.startswith("proprietary_") or repo_name == "android_kernel_samsung_tuna":
